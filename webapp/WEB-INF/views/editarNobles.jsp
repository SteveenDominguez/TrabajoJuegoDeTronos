...
<body>
	...
	<form action="guardarNuevoNoble" method="post">
		<div class="form-group">
			<input type="text" style="visibility: hidden" class="form-control"
				name="id" id="id" required="required" value="${noble.id}" />
		</div>
		<div class="form-group">
			<label for="exampleInputText1">Nombre</label> <input type="text"
				class="form-control" id="nombre" name="nombre" placeholder="nombre"
				required value="${noble.nombre}">
		</div>
		<div class="form-group">
			<label for="exampleInputText1">Pues ahora si puede cambiar si se es digno o no :(</label> <input type="text"
				class="form-control" id="digno" name="digno" placeholder="digno"
