...
<body>
	...
	<form action="guardarNuevaRegion" method="post">
		<div class="form-group">
			<input type="text" style="visibility: hidden" class="form-control"
				name="id" id="id" required="required" value="${region.id}" />
		</div>
		<div class="form-group">
			<label for="exampleInputText1">Nombre</label> <input type="text"
				class="form-control" id="nombre" name="nombre" placeholder="nombre"
				required value="${region.nombre}">
		</div>
		<div class="form-group">
			<label for="exampleInputText1">Clima</label> <input type="text"
				class="form-control" id="clima" name="clima" placeholder="clima"
				required value="${region.clima}">
		</div>
		<div class="form-group">
			<label for="exampleInputText1">Mapa</label> <input type="text"
				class="form-control" id="mapa" name="mapa" placeholder="mapa"
				required value="${region.mapa}">
		</div>
